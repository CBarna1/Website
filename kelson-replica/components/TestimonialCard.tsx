...
export default function TestimonialCard({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/40 dark:backdrop-blur-md">
